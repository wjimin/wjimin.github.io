...
![a](https://github.com/wjimin/My_Picture/blob/master/2020.10.21/2020.10.20.a.png)
### 题目大意：
1. 有 10000 套公寓，编号从 1 到 10000 。
2. 现在有一个人特别无聊，他会拨打编号上数字都相同的公寓住户号码，直到有人接听才停止，拨打顺序按递增规律，即：1 −> 11 −> 111 −> 1111 −>2−> 22 ->222 -> 2222-> 3 -> 33 ->----9999。
3. 现给出接听了电话的住户编号，问这个无聊的人总共按了几次数字。
### 思路：
...
![b](https://github.com/wjimin/My_Picture/blob/master/2020.10.21/2020.10.20.b.png)
### 题目大意：
...
![b](https://github.com/wjimin/My_Picture/blob/master/2020.10.21/2020.10.20.c.png)
### 题目大意：
1. 给你一堆序列，一开始选择一个数，每次可以进行一次操作。

2. 如果当前数大于临近的数则可以把周围数“吃掉”，然后序列数减一，该数加一。

3. 经过多次操作后如果可以把序列数变为1，如果存在这样的数则输出该数的下标,否则输出-1。
...
![d](https://github.com/wjimin/My_Picture/blob/master/2020.10.21/2020.10.20.d.png)
...
![e](https://github.com/wjimin/My_Picture/blob/master/2020.10.21/2020.10.20.e.png)
### 题目大意：
...
3. 总共的分配方式是 N！ 种（将所有位置看作坑位，第一个坑位能选N个人，第二坑位能选
择N-1人）
4. 因为人分为两部分，两部分是等价的，所以坑位1与N/2+1实际上是等价的。所以总分配方
式要除2.
